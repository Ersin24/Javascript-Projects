...
function Game(){
    ...
    function handlePlayerChoice(choice){
        ...
        if(choice.name === codeyChoice.name){
            ...
            (choice.name === "rock" && codeyChoice.name === "scissors") || (choice.name === "paper" && codeyChoice.name === "rock") || (choice.name === "scissors" && codeyChoice.name=== "paper")
        ){
            setResult("You win!")
        }else{
            setResult("You lose!")
                ...
                <div className={styles.results}>
                    ...
                    <div style={choiceStyles}>
                        <span style={emojiStyles}>{codeyChoice.emoji}</span>
                            <p style={nameStyles}>You chose {codeyChoice.name}</p>
                    </div>
